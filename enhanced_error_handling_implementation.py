...
def handle_api_operation(max_retries: int = 3, timeout: float = 30.0):
    ...
    return handle_critical_operation(
        operation_type="api", max_retries=max_retries, timeout=timeout
    )
...
def handle_llm_operation(max_retries: int = 3, timeout: float = 60.0):
    ...
    return handle_critical_operation(
        operation_type="llm", max_retries=max_retries, timeout=timeout
    )
...
def handle_database_operation(max_retries: int = 3, timeout: float = 30.0):
    ...
    return handle_critical_operation(
        operation_type="database", max_retries=max_retries, timeout=timeout
    )
...
def handle_cache_operation(max_retries: int = 2, timeout: float = 10.0):
    ...
    return handle_critical_operation(
        operation_type="cache", max_retries=max_retries, timeout=timeout
    )
...
def handle_file_operation(max_retries: int = 2, timeout: float = 30.0):
    ...
    return handle_critical_operation(
        operation_type="file", max_retries=max_retries, timeout=timeout
    )
...
async def safe_vector_search_call(
    ...
    **kwargs,
    ...
    @handle_critical_operation(
        operation_type="vector_search", max_retries=max_retries, timeout=timeout
    )
...
async def safe_query_classification_call(
    ...
    **kwargs,
    ...
    @handle_critical_operation(
        operation_type="query_classification", max_retries=max_retries, timeout=timeout
    )
...
async def safe_agent_orchestration_call(
    ...
    **kwargs,
    ...
    @handle_critical_operation(
        operation_type="agent_orchestration", max_retries=max_retries, timeout=timeout
    )
...
async def safe_configuration_load_call(
    ...
    **kwargs,
    ...
    @handle_critical_operation(
        operation_type="configuration", max_retries=max_retries, timeout=timeout
    )
...
async def verify_enhanced_error_handling():
    ...
    try:
        result = await error_handler.handle_critical_operation(
            "test_api", lambda: asyncio.sleep(0.1), timeout=1.0
        )
    ...
    try:
        result = await error_handler.handle_critical_operation(
            "test_llm", lambda: asyncio.sleep(0.1), timeout=1.0
        )
    ...
    try:
        result = await error_handler.handle_critical_operation(
            "test_database", lambda: asyncio.sleep(0.1), timeout=1.0
        )
