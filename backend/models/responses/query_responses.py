...
class ComprehensiveQueryResponse(BaseModel):
    ...
    alternatives: List[Dict[str, Any]] = Field(default_factory=list, description="Alternative answers")
    quality_metrics: Dict[str, Any] = Field(default_factory=dict, description="Quality assessment")
    created_at: datetime = Field(..., description="Query creation timestamp")
    metadata: Dict[str, Any] = Field(default_factory=dict, description="Additional metadata")
