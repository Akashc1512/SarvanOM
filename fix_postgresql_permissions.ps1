# PostgreSQL Permission Fix Script for SarvanOM
# Run this script as Administrator

Write-Host "🔧 PostgreSQL Permission Fix for SarvanOM" -ForegroundColor Green
...
# Step 2: Fix permissions on PostgreSQL directories
Write-Host "`n🔧 Step 2: Fixing PostgreSQL permissions..." -ForegroundColor Yellow
$postgresPath = "C:\Program Files\PostgreSQL\17"
$postgresDataPath = "$postgresPath\data"

# Take ownership of PostgreSQL directory
try {
...
# Step 3: Remove existing data directory and recreate
Write-Host "`n🔧 Step 3: Recreating PostgreSQL data directory..." -ForegroundColor Yellow
...
Write-Host "`n🔧 Step 4: Initializing PostgreSQL data directory..." -ForegroundColor Yellow
...
Write-Host "`n🔧 Step 5: Configuring PostgreSQL for local connections..." -ForegroundColor Yellow
...
Write-Host "`n🔧 Step 6: Starting PostgreSQL service..." -ForegroundColor Yellow
try {
...
# Step 7: Wait and test connection
Write-Host "`n🔧 Step 7: Testing PostgreSQL connection..." -ForegroundColor Yellow
...
Write-Host "`n🔧 Step 8: Creating database and user..." -ForegroundColor Yellow
try {
    # Create database
...
# Step 9: Test new connection
Write-Host "`n🔧 Step 9: Testing new connection..." -ForegroundColor Yellow
try {
...
# Step 10: Provide .env configuration
Write-Host "`n📋 Step 10: .env Configuration" -ForegroundColor Yellow
...
Write-Host "`n✅ PostgreSQL permission fix completed!" -ForegroundColor Green
