...
class StructuredLogger:
    ...
    def _log_with_context(self, level: int, message: str, **kwargs):
        ...
        extra_fields = {"service": self.name, "context": kwargs}
...
def log_database_query(
    query: str, duration: float, success: bool, error: Optional[str] = None
):
    """Log database query details."""
    logger = get_logger("database")
    logger.info(
        "Database Query", query=query, duration=duration, success=success, error=error
    )
...
def log_performance_metric(
    metric_name: str, value: float, unit: str, tags: Optional[Dict[str, Any]] = None
):
...
def log_shutdown():
    ...
    logger.info("Application Shutdown", timestamp=datetime.utcnow().isoformat())
