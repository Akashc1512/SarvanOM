...
class SecurityConfig:
    ...
    def __init__(self):
        ...
        self.access_token_expire_minutes = self.security_config.get("access_token_expire_minutes", 30)
        self.refresh_token_expire_days = self.security_config.get("refresh_token_expire_days", 7)
    ...
    def check_rate_limit(self, identifier: str, limit_type: str = "per_minute") -> bool:
        ...
        self.rate_limit_tracking[identifier][limit_type] = [
            ts for ts in self.rate_limit_tracking[identifier][limit_type]
    ...
    def check_account_lockout(self, identifier: str, max_attempts: int = 5, lockout_duration: int = 15) -> bool:
