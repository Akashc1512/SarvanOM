...
from services.synthesis_service.recommendation_service import RecommendationService, Recommendation
...
class TestRecommendationService:
    ...
    async def test_get_recommendations(self, recommendation_service):
        ...
        with patch.object(recommendation_service.knowledge_graph, 'query_knowledge_graph') as mock_query:
    ...
    async def test_health_status(self, recommendation_service):
        ...
        with patch.object(recommendation_service.knowledge_graph, 'connected', True):
            with patch.object(recommendation_service.knowledge_graph, 'get_health_status') as mock_health:
...
async def test_integration_recommendation_flow():
    ...
    with patch.object(service.knowledge_graph, 'connected', True):
        with patch.object(service.knowledge_graph, 'query_knowledge_graph') as mock_query:
