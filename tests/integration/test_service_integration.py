...
class TestServiceIntegration:
    ...
    async def test_knowledge_find_paths(self, client, mock_knowledge_service):
        ...
        with patch(
            ...
            response = client.post(
                "/agents/knowledge/paths",
                json={"from_entity": "entity1", "to_entity": "entity2"},
            )
    ...
    async def test_code_service_injection(self, client, mock_code_service):
        ...
        with patch(
            ...
            return_value=mock_code_service,
        ):
            response = client.post(
                "/agents/code/execute",
    ...
    async def test_crawler_service_injection(self, client, mock_crawler_service):
        ...
        with patch(
            ...
            return_value=mock_crawler_service,
        ):
            response = client.post(
    ...
    async def test_backward_compatibility_response_format(
        self, client, mock_browser_service
    ):
    ...
    async def test_error_response_format(self, client):
        ...
        response = client.post("/agents/browser/search", json={"invalid": "request"})
