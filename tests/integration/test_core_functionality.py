...
class TestCoreComponents:
    ...
    def test_query_context_creation(self):
        ...
        context = QueryContext(query="test query", user_id="user123", session_id="session456")
    ...
    def test_agent_result_creation(self):
        ...
        result = AgentResult(success=True, data="test data", confidence=0.95, execution_time_ms=150)
    ...
    def test_agent_message_creation(self):
        ...
        message = AgentMessage(
            ...
            payload={"task": {"query": "test query"}, "metadata": {"test": True}},
        )
