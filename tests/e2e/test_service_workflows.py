...
class TestServiceWorkflows:
    ...
    def mock_services(self):
        ...
        browser_service.extract_content = AsyncMock(return_value={
            "success": True,
            "data": {"content": "Extracted content from webpage"},
            "service_used": "BrowserService"
        })
        browser_service.browse_page = AsyncMock(return_value={
            "success": True,
            "data": {"page_content": "Full page content", "title": "Test Page"},
            "service_used": "BrowserService"
        })
        browser_service.health_check = AsyncMock(return_value={
            "status": "healthy",
        ...
        pdf_service.extract_text = AsyncMock(return_value={
            "success": True,
            "data": {"text": "Extracted text from PDF"},
            "service_used": "PDFService"
        })
        pdf_service.extract_images = AsyncMock(return_value={
            "success": True,
            "data": {"images": ["image1.png", "image2.png"]},
            "service_used": "PDFService"
        })
        pdf_service.analyze_pdf = AsyncMock(return_value={
            "success": True,
            "data": {"analysis": "PDF analysis result", "complexity": "medium"},
            "service_used": "PDFService"
        })
        pdf_service.health_check = AsyncMock(return_value={
            "status": "healthy",
            "service": "PDFService"
        })
        ...
        knowledge_service.query_relationships = AsyncMock(return_value={
            "success": True,
            "data": {
                "relationships": [
        ...
        knowledge_service.find_paths = AsyncMock(return_value={
            "success": True,
            "data": {"paths": [["1", "2", "3"], ["1", "4", "3"]]},
            "service_used": "KnowledgeService"
        })
        knowledge_service.search_entities = AsyncMock(return_value={
            "success": True,
            "data": {"entities": [{"id": "1", "name": "Search Result"}]},
            "service_used": "KnowledgeService"
        })
        knowledge_service.health_check = AsyncMock(return_value={
            "status": "healthy",
        ...
        code_service.validate_syntax = AsyncMock(return_value={
            "success": True,
            "data": {"valid": True, "errors": []},
            "service_used": "CodeService"
        })
        code_service.analyze_code = AsyncMock(return_value={
            "success": True,
            "data": {"complexity": "low", "lines": 5, "functions": 1},
            "service_used": "CodeService"
        })
        code_service.upload_and_execute = AsyncMock(return_value={
            "success": True,
            "data": {"result": "Code executed successfully"},
            "service_used": "CodeService"
        })
        code_service.health_check = AsyncMock(return_value={
            "status": "healthy",
            "service": "CodeService"
        })
        ...
        database_service.get_schema = AsyncMock(return_value={
            "success": True,
            "data": {
        ...
        database_service.analyze_data = AsyncMock(return_value={
            "success": True,
            "data": {"analysis": "Data analysis result", "insights": ["insight1", "insight2"]},
            "service_used": "DatabaseService"
        })
        database_service.optimize_query = AsyncMock(return_value={
            "success": True,
            "data": {"optimized_query": "SELECT * FROM users WHERE id = 1"},
            "service_used": "DatabaseService"
        })
        database_service.list_databases = AsyncMock(return_value={
            "success": True,
            "data": {"databases": ["test_db", "prod_db", "dev_db"]},
            "service_used": "DatabaseService"
        })
        database_service.test_connection = AsyncMock(return_value={
            "success": True,
            "data": {"connected": True, "response_time": "0.1s"},
            "service_used": "DatabaseService"
        })
        database_service.health_check = AsyncMock(return_value={
            "status": "healthy",
        ...
        crawler_service.extract_content = AsyncMock(return_value={
            "success": True,
            "data": {"content": "Extracted content from crawled page"},
            "service_used": "CrawlerService"
        })
        crawler_service.discover_links = AsyncMock(return_value={
            "success": True,
            "data": {
                "links": [
                    "http://link1.com",
        ...
        crawler_service.generate_sitemap = AsyncMock(return_value={
            "success": True,
            "data": {"sitemap": "Generated sitemap XML"},
            "service_used": "CrawlerService"
        })
        crawler_service.crawl_with_filters = AsyncMock(return_value={
            "success": True,
            "data": {"filtered_results": "Filtered crawl results"},
            "service_used": "CrawlerService"
        })
        crawler_service.health_check = AsyncMock(return_value={
            "status": "healthy",
    ...
    async def test_complete_browser_workflow(self, client, mock_services):
        ...
        with patch('services.api_gateway.routes.agents.browser_agent.get_browser_service', return_value=services["browser"]):
            ...
            search_response = client.post("/agents/browser/search", json={
            ...
            extract_response = client.post("/agents/browser/extract", json={
                "url": "http://test1.com",
            ...
            browse_response = client.post("/agents/browser/browse", json={
                "url": "http://test2.com"
            })
    ...
    async def test_complete_pdf_workflow(self, client, mock_services):
        ...
        with patch('services.api_gateway.routes.agents.pdf_agent.get_pdf_service', return_value=services["pdf"]):
            ...
            extract_images_response = client.post("/agents/pdf/extract-images", files=files)
    ...
    async def test_complete_knowledge_workflow(self, client, mock_services):
        ...
        with patch('services.api_gateway.routes.agents.knowledge_agent.get_knowledge_service', return_value=services["knowledge"]):
            # Step 1: Query entities
            query_response = client.post("/agents/knowledge/query", json={
            ...
            relationships_response = client.post("/agents/knowledge/relationships", json={
                "entity_id": "1"
            })
            ...
            paths_response = client.post("/agents/knowledge/paths", json={
                "from_entity": "1",
                "to_entity": "3"
            })
            ...
            search_response = client.post("/agents/knowledge/search", json={
    ...
    async def test_complete_code_workflow(self, client, mock_services):
        ...
        with patch('services.api_gateway.routes.agents.code_agent.get_code_service', return_value=services["code"]):
            # Step 1: Execute code
            execute_response = client.post("/agents/code/execute", json={
            ...
            validate_response = client.post("/agents/code/validate", json={
                "code": "print('Hello World')",
                "language": "python"
            })
            ...
            # Step 3: Analyze code
            analyze_response = client.post("/agents/code/analyze", json={
                "code": "print('Hello World')",
                "language": "python"
            })
            ...
            upload_response = client.post("/agents/code/upload-execute", json={
                "code": "print('Uploaded code')",
                "language": "python"
            })
    ...
    async def test_complete_database_workflow(self, client, mock_services):
        ...
        with patch('services.api_gateway.routes.agents.database_agent.get_database_service', return_value=services["database"]):
            # Step 1: Test connection
            test_connection_response = client.post("/agents/database/test-connection", json={
                "database": "test_db"
            })
            ...
            query_response = client.post("/agents/database/query", json={
            ...
            # Step 4: Analyze data
            analyze_response = client.post("/agents/database/analyze", json={
                "database": "test_db",
                "table": "users"
            })
            ...
            optimize_response = client.post("/agents/database/optimize", json={
    ...
    async def test_complete_crawler_workflow(self, client, mock_services):
        ...
        with patch('services.api_gateway.routes.agents.crawler_agent.get_crawler_service', return_value=services["crawler"]):
            # Step 1: Crawl website
            crawl_response = client.post("/agents/crawler/crawl", json={
                "url": "http://test.com",
                "max_pages": 10
            })
            ...
            extract_response = client.post("/agents/crawler/extract", json={
                "url": "http://test.com",
                "extract_type": "content"
            })
            ...
            discover_response = client.post("/agents/crawler/discover", json={
                "url": "http://test.com"
            })
            ...
            sitemap_response = client.post("/agents/crawler/sitemap", json={
                "url": "http://test.com"
            })
            ...
            filtered_response = client.post("/agents/crawler/crawl-filtered", json={
                "url": "http://test.com",
    ...
    async def test_cross_service_interaction(self, client, mock_services):
        ...
        with patch('services.api_gateway.routes.agents.browser_agent.get_browser_service', return_value=services["browser"]), \
             patch('services.api_gateway.routes.agents.pdf_agent.get_pdf_service', return_value=services["pdf"]), \
             patch('services.api_gateway.routes.agents.knowledge_agent.get_knowledge_service', return_value=services["knowledge"]):
            ...
            knowledge_response = client.post("/agents/knowledge/query", json={
    ...
    async def test_error_propagation_across_services(self, client, mock_services):
        ...
        services["browser"].search_web = AsyncMock(side_effect=Exception("Browser service error"))
        services["pdf"].process_pdf = AsyncMock(side_effect=Exception("PDF service error"))
        
        with patch('services.api_gateway.routes.agents.browser_agent.get_browser_service', return_value=services["browser"]), \
             patch('services.api_gateway.routes.agents.pdf_agent.get_pdf_service', return_value=services["pdf"]):
            
            # Test browser service error
            browser_response = client.post("/agents/browser/search", json={
                "query": "test query",
                "search_engine": "google"
            })
