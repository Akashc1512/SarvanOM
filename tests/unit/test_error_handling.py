...
from shared.core.api.exceptions import (
    ...
    ValidationError as UKPValidationError, QueryProcessingError
)
from services.api_gateway.middleware.error_handling import (
    ErrorHandlingMiddleware, handle_service_error, validate_service_response,
    log_service_operation, create_error_handling_middleware
)
...
class TestErrorHandlingMiddleware:
    ...
    @pytest.mark.asyncio
    async def test_http_exception_handling(self, middleware, mock_request, mock_call_next):
    ...
    @pytest.mark.asyncio
    async def test_validation_error_handling(self, middleware, mock_request, mock_call_next):
    ...
    @pytest.mark.asyncio
    async def test_ukp_http_exception_handling(self, middleware, mock_request, mock_call_next):
    ...
    @pytest.mark.asyncio
    async def test_connection_error_handling(self, middleware, mock_request, mock_call_next):
    ...
    @pytest.mark.asyncio
    async def test_timeout_error_handling(self, middleware, mock_request, mock_call_next):
    ...
    @pytest.mark.asyncio
    async def test_permission_error_handling(self, middleware, mock_request, mock_call_next):
    ...
    @pytest.mark.asyncio
    async def test_generic_exception_handling(self, middleware, mock_request, mock_call_next):
