...
terraform {
  ...
  backend "s3" {
    bucket = "universal-knowledge-hub-terraform-state"
...
provider "aws" {
  ...
  default_tags {
    tags = {
      Project     = "universal-knowledge-hub"
...
resource "aws_elasticache_replication_group" "redis" {
  ...
  replication_group_description = "Redis cluster for Universal Knowledge Platform"
