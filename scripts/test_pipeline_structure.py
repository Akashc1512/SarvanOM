...
async def test_imports():
    ...
    try:
        # Test basic imports
        from shared.core.agents.base_agent import BaseAgent, AgentResult, QueryContext, AgentType
        print("✅ BaseAgent imports successful")
        
        from shared.core.agents.standardized_agents import ExtendedAgentType, create_agent
        print("✅ StandardizedAgents imports successful")
        
        from shared.core.agents.refined_lead_orchestrator import RefinedLeadOrchestrator, PipelineConfig
...
async def test_pipeline_config():
    ...
    try:
        ...
        print(f"✅ Custom config created with {len(custom_config.enabled_agents)} agents")
...
async def test_mock_parallel_execution():
    ...
    try:
        ...
        for i, result in enumerate(results):
            ...
            print(f"   {agent_name}: Success={result.success}, Confidence={result.confidence}")
...
async def test_agent_result():
    ...
    try:
        ...
        print(f"✅ Success result: {success_result.success}, confidence: {success_result.confidence}")
