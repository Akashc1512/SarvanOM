...
class HardcodedConfigRefactorer:
    ...
    def generate_replacement_suggestions(self, file_path: Path, hardcoded_values: Dict[str, List[str]]) -> Dict[str, str]:
    ...
    def apply_replacements(self, file_path: Path, suggestions: Dict[str, str]) -> bool:
        ...
        for old_value, new_value in suggestions.items():
            if old_value in content:
                ...
                if "get_config_value" in new_value and "from shared.core.config.central_config import" not in content:
