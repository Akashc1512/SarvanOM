...
def test_file_logging():
    ...
    with tempfile.TemporaryDirectory() as temp_dir:
        ...
        logger.info(
            "Test message for file logging", component="file_test", test_file=log_file
        )
...
def test_environment_configuration():
    ...
    for env, level, format_type in test_environments:
        ...
        logger.info(
            f"Test message for {env} environment",
            environment=env,
...
async def test_performance_logging():
    ...
    with log_execution_time(
        logger, "test_operation", operation_type="performance_test"
    ):
...
def test_agent_logging():
    ...
    for agent in agents:
        ...
        log_agent_lifecycle(
            logger, agent, "finish", task_id="task-001", duration_ms=150, result_count=5
        )
...
def test_query_logging():
    ...
    for i, query in enumerate(test_queries):
        ...
        log_query_event(
            logger, query, "received", query_id=query_id, user_id="test-user"
        )
...
def test_error_scenarios():
    ...
    try:
        ...
        logger.exception(
            "Key error during data processing",
