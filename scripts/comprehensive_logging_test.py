...
from unified_logging import setup_logging, get_logger, log_execution_time, log_agent_lifecycle, log_query_event
...
def test_environment_configurations():
    ...
    for env, level, format_type in environments:
        ...
        logger.info(f"✅ {env} environment configured successfully",
                   environment=env,
                   log_level=level,
...
def test_error_handling():
    ...
    logger.warning("Service degradation detected",
