...
class LeadOrchestrator:
    ...
    def __init__(self, config: Optional[Dict[str, Any]] = None):
        ...
        """
        logger.info(
            "🚀 Initializing LeadOrchestrator with refined pipeline",
    ...
    async def process_query(
        ...
        try:
            ...
            result: PipelineResult = await self.orchestrator.process_query(
                query, user_context
            )
            ...
            if result.errors:
                ...
                response["warnings"] = (
                    f"Some agents failed: {', '.join(result.failed_agents)}"
                )
    ...
    def register_agent(self, agent_type: str, agent):
        ...
        try:
            ...
            logger.info(
                f"Registered new agent: {agent_type}",
    ...
    def unregister_agent(self, agent_type: str):
        ...
        try:
            ...
            logger.info(
                f"Unregistered agent: {agent_type}",
                agent_type=agent_type,
                component="orchestrator",
            )
        except ValueError:
    ...
    def get_available_agents(self) -> List[str]:
        ...
        """
        return [
            agent_type.value for agent_type in self.orchestrator.agent_registry.keys()
        ]
    ...
    def get_pipeline_status(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "pipeline_stages": [
                stage.value for stage in self.orchestrator.pipeline_stages.keys()
            ],
        }
