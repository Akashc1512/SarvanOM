...
UserResponse = user_management.UserResponse
...
async def change_password(
    current_password: str, new_password: str, current_user=Depends(get_current_user)
):
...
async def create_user(user_create: UserCreate, current_user=Depends(get_current_user)):
    """
...
async def update_user_role(
    username: str, new_role: str, current_user=Depends(get_current_user)
):
    """
...
async def deactivate_user(username: str, current_user=Depends(get_current_user)):
    """
