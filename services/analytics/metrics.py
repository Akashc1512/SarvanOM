...
CACHE_SIZE = Gauge(
    "ukp_cache_size", "Current cache size", ["cache_type"], registry=registry
)
...
# System metrics
SYSTEM_MEMORY = Gauge(
    "ukp_system_memory_bytes", "System memory usage in bytes", registry=registry
)

SYSTEM_CPU = Gauge(
    "ukp_system_cpu_percent", "System CPU usage percentage", registry=registry
)
    ...
    def get_metrics_dict(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "requests": {
                ...
                "duration_avg": REQUEST_DURATION._sum.sum()
...
def record_business_metrics(
    category: str, confidence: float, response_length: int, endpoint: str
):
