...
async def agents_health_check(current_user=Depends(get_current_user)) -> AgentResponse:
    """
...
async def agents_status(current_user=Depends(get_current_user)) -> AgentResponse:
    """
