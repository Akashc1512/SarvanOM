...
async def execute_database_query(
    ...
    try:
        ...
        result = await database_service.execute_query(
            database_name=database_name, query=query, params=params, timeout=timeout
        )
...
async def analyze_database_data(
    ...
    try:
        ...
        result = await database_service.analyze_data(
            database_name=database_name, table_name=table_name, columns=columns
        )

        processing_time = tracker.get_processing_time()
        metadata = create_agent_metadata(
            user_id, database_name=database_name, table_name=table_name
        )
...
async def optimize_database_query(
    ...
    try:
        ...
        processing_time = tracker.get_processing_time()
        metadata = create_agent_metadata(
            user_id, database_name=database_name, query_length=len(query)
        )
