...
async def execute_code(
    ...
    try:
        ...
        result = await code_service.execute_code(
            code=code, language=language, inputs=inputs, timeout=timeout
        )
...
async def validate_code(
    ...
    try:
        ...
        result = await code_service.validate_syntax(code=code, language=language)
...
async def analyze_code(
    ...
    try:
        ...
        result = await code_service.analyze_code(code=code, language=language)
...
async def upload_and_execute(
    ...
    try:
        ...
        result = await code_service.upload_and_execute(
            file_content=file_content, filename=file.filename, language=language
        )
