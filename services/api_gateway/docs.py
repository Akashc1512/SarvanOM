...
class DocumentationConfig:
    ...
    def __init__(self):
        ...
        self.tags = [
            ...
            {"name": "Feedback", "description": "User feedback and rating endpoints"},
...
class QueryRequestDoc(QueryRequestValidator):
...
class APIDocumentationGenerator:
    ...
    def _add_examples(self, schema: Dict[str, Any]) -> None:
        ...
        schema["paths"]["/api/v2/query"]["post"]["requestBody"]["content"][
            "application/json"
        ]["examples"] = {
            "simple_query": {
...
"""
        ...
        if "requestBody" in operation:
            doc += "**Request Body:**\n\n"
            doc += "```json\n"
            examples = operation["requestBody"]["content"]["application/json"].get(
                "examples", {}
            )
            if examples:
