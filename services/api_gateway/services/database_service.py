...
class DatabaseService(BaseAgentService):
    ...
    def __init__(
        ...
        self.supported_databases = self.get_config(
    ...
    async def health_check(self) -> Dict[str, Any]:
        ...
        try:
            ...
            return {"healthy": False, "database_connections": "FAILED", "error": str(e)}
        ...
        try:
            ...
            if not query or not query.strip():
                raise ValidationError(
                    field="query", message="Query cannot be empty", value=query
                )
            ...
            raise DatabaseError(
                operation="execute_query", error=str(e), database=database_name
            )
    ...
    async def _test_database_connection(self, database_name: str) -> Dict[str, Any]:
        ...
        try:
            ...
            return {"success": True, "database": database_name, "status": "connected"}

        except Exception as e:
            return {"success": False, "database": database_name, "error": str(e)}
