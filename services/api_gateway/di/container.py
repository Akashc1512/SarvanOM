...
class DIContainer:
    ...
    def resolve(self, service_type: str, scope_id: Optional[str] = None) -> Any:
        ...
        try:
            if lifetime == ServiceLifetime.SINGLETON:
                ...
                return self._resolve_scoped(service_type, implementation, config, scope_id)
            else:
    ...
    def _resolve_singleton(self, service_type: str, implementation: Union[Type, Callable], config: Dict[str, Any]) -> Any:
    ...
    def _resolve_transient(self, service_type: str, implementation: Union[Type, Callable], config: Dict[str, Any]) -> Any:
    ...
    def _resolve_scoped(self, service_type: str, implementation: Union[Type, Callable], config: Dict[str, Any], scope_id: str) -> Any:
        ...
        logger.debug(f"Created scoped instance for service: {service_type} in scope: {scope_id}")
        return instance
    
    def _create_instance(self, implementation: Union[Type, Callable], config: Dict[str, Any]) -> Any:
