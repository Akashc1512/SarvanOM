...
from shared.core.api.exceptions import UniversalKnowledgeError
...
from shared.core.rate_limiter import get_rate_limiter
...
from services.auth-service.user_management_v2 import get_user_manager
...
class SystemIntegrationManager:
    ...
    async def _start_component(self, component_name: str) -> None:
        ...
        try:
            ...
            logger.error(
                "Component startup failed", component=component_name, error=str(e)
            )
            raise
    ...
    async def _stop_component(self, component_name: str) -> None:
        ...
        try:
            ...
            logger.error(
                "Component shutdown failed", component=component_name, error=str(e)
            )
    ...
    async def _perform_health_checks(self) -> None:
        ...
        if unhealthy_components:
            ...
            logger.warning(
                "System health degraded", unhealthy_components=unhealthy_components
            )
        else:
            self.state = SystemState.RUNNING
