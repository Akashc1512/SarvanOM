        ...
        <div className="flex justify-between items-center">
          <div>
            ...
            <p className="text-gray-600">
              Monitor system health, performance, and integrations
            </p>
          </div>
          ...
          {apiInfo ? (
            <div className="space-y-3">
              ...
              <div className="flex justify-between">
                ...
                <span
                  className={`px-2 py-1 rounded-full text-xs font-medium ${getStatusColor(apiInfo.status)}`}
                >
                  {apiInfo.status}
                </span>
              </div>
          ...
          {metrics && !("error" in metrics) ? (
            <div className="space-y-3">
              <div className="flex justify-between">
                ...
                <span className="font-medium">
                  {metrics.sarvanom_requests_total || 0}
                </span>
              </div>
              <div className="flex justify-between">
                <span className="text-gray-600">Errors:</span>
                <span className="font-medium text-red-600">
                  {metrics.sarvanom_errors_total || 0}
                </span>
              </div>
              <div className="flex justify-between">
                <span className="text-gray-600">Cache Hits:</span>
                <span className="font-medium text-green-600">
                  {metrics.sarvanom_cache_hits_total || 0}
                </span>
              </div>
              <div className="flex justify-between">
                <span className="text-gray-600">Cache Misses:</span>
                <span className="font-medium text-orange-600">
                  {metrics.sarvanom_cache_misses_total || 0}
                </span>
              </div>
              <div className="flex justify-between">
                ...
                <span className="font-medium">
                  {(
                    metrics.sarvanom_average_response_time_seconds || 0
                  ).toFixed(3)}
                  s
                </span>
              </div>
              <div className="flex justify-between">
                ...
                <span className="font-medium">
                  {metrics.sarvanom_active_users || 0}
                </span>
              </div>
            </div>
          ) : (
                ...
                {Object.entries(integrations.integrations).map(
                  ([name, info]) => (
                    ...
                    >
                      ...
                      <span
                        className={`px-2 py-1 rounded-full text-xs font-medium ${getStatusColor(info.status)}`}
                      >
                        {info.status}
                      </span>
                    </div>
