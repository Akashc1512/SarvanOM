      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="grid md:grid-cols-3 gap-6 mb-8">
          <div className="bg-white p-6 rounded-lg shadow-sm border">
            ...
            <h3 className="text-lg font-semibold text-gray-900 mb-2">Visual Content</h3>
          ...
          <div className="bg-white p-6 rounded-lg shadow-sm border">
            ...
            <h3 className="text-lg font-semibold text-gray-900 mb-2">Audio & Archives</h3>
            <p className="text-gray-600">
        ...
        {/* Query Section */}
        <div className="bg-white rounded-lg shadow-sm border p-6 mb-8">
          <h2 className="text-2xl font-bold text-gray-900 mb-4">Query Your Knowledge</h2>
