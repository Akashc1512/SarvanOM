...
const mockResponses = {
  "capital of france": {
    answer:
      "Paris is the capital of France. It is the largest city in France and serves as the country's political, economic, and cultural center.",
    confidence: 0.95,
    citations: [
      {
        id: "1",
  ...
  photosynthesis: {
    answer:
      "Photosynthesis is the process by which plants, algae, and some bacteria convert light energy into chemical energy. This process produces oxygen as a byproduct and is essential for life on Earth.",
    confidence: 0.88,
    citations: [
      {
        id: "2",
  ...
  setTimeout(
    () => {
      ...
      if (queryLower.includes("capital") && queryLower.includes("france")) {
        ...
        response = {
          answer:
            "This is a prototype system with limited knowledge. For this query, I would need to access real search engines and language models to provide an accurate answer. In the full version, this would be processed by multiple AI agents to retrieve and synthesize information from reliable sources.",
          confidence: 0.3,
          citations: [],
